...
default_omniglot_url = "https://github.com/yburda/iwae/raw/master/datasets/OMNIGLOT/chardata.mat"
...
def get_omniglot_batch(
  ...
  if not os.path.exists('omniglot.mat'):
    urllib.request.urlretrieve(default_omniglot_url, 'omniglot.mat')
  omni_raw = scipy.io.loadmat('omniglot.mat')     
